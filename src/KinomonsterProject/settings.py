"""
Django settings for KinomonsterProject project.
...
SECRET_KEY = 'django-insecure-m27wo$7h7a82+#dz44!k#-71%297wi8763l*u*e@(i^7y$=3$d'
...
ROOT_URLCONF = 'KinomonsterProject.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                #'KinomonsterApp.context_processors.get_login_and_register_data',
            ],
        },
    },
]

WSGI_APPLICATION = 'KinomonsterProject.wsgi.application'
